...
TEST(KpsrDdsCodegenTest3, compositionTypeMapperTest) {
    ...
    fromDDSProvider.registerToTopic("kpsr_dds_codegen_test_topic3", &dataReader, true, basicProvider.getPublisher());
    ...
    fromDDSProvider.unregisterFromTopic("kpsr_dds_codegen_test_topic3", &dataReader);
}
