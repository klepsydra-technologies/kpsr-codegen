...
TEST(KpsrDdsCodegenTest4, inheritanceMapperMapperTest) {
    ...
    fromDDSProvider.registerToTopic("kpsr_dds_codegen_test_topic4", &dataReader, true, basicProvider.getPublisher());
    ...
    fromDDSProvider.unregisterFromTopic("kpsr_dds_codegen_test_topic4", &dataReader);
}
