...
#ifndef PRIMITIVE_TYPES_VECTOR_MAPPER_ROS
#define PRIMITIVE_TYPES_VECTOR_MAPPER_ROS

#include <klepsydra/serialization/mapper.h>

#include <kpsr_ros_codegen/PrimitiveTypesVector.h>
#include <klepsydra/codegen/primitive_types_vector.h>

namespace kpsr {
template <>

class Mapper<kpsr::codegen::PrimitiveTypesVector, kpsr_ros_codegen::PrimitiveTypesVector> {
public:
   void fromMiddleware(const kpsr_ros_codegen::PrimitiveTypesVector & message, kpsr::codegen::PrimitiveTypesVector & event) {
   ...
   void toMiddleware(const kpsr::codegen::PrimitiveTypesVector &event, kpsr_ros_codegen::PrimitiveTypesVector &message) {
...
#endif // PRIMITIVE_TYPES_VECTOR_MAPPER_ROS