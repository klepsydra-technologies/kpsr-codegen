...
#ifndef COMPOSITION_TYPE_MAPPER_ROS
#define COMPOSITION_TYPE_MAPPER_ROS
...
#include <kpsr_ros_codegen/CompositionType.h>

namespace kpsr {
template <>

class Mapper<kpsr::codegen::CompositionType, kpsr_ros_codegen::CompositionType> {
public:
   void fromMiddleware(const kpsr_ros_codegen::CompositionType & message, kpsr::codegen::CompositionType & event) {
   ...
   void toMiddleware(const kpsr::codegen::CompositionType &event, kpsr_ros_codegen::CompositionType &message) {
...
#endif // COMPOSITION_TYPE_MAPPER_ROS